...
namespace PestControlEngine.GUI
{
    public class UITextBox : UIElement
    {
        ...
        public UITextBox()
        {
            ...
            MouseClickedEvent += UITextBox_MouseClickedEvent;
        }

        private void UITextBox_MouseClickedEvent(MouseEventArgs e)
        {
            CurrentSelectedChar = FindNearestGlyphIndex(new Point((int)e.Position.X, (int)e.Position.Y), e.gameInfo);
        }
